export default function CircularsPage() {
    ...
    const categories = ["All", "FEON", "RBBAE", "RBBSA"];

    return (
        <div className="p-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Union Notices</h1>
                    <p className="text-gray-600 dark:text-gray-300">Official communications to Unions</p>
                </div>
